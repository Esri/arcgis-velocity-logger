...
${BOLD}${WHITE}OPTIONS${RESET}
  ...
  ${BOLD}--sign-script <path>${RESET}
        ...
        or final artifact folder), and the official product name (${BOLD}ArcGIS Velocity Logger${RESET}).
  ...
  ${BOLD}--sign-product-names <names>${RESET}
        ...
        Defaults to the official app product name (${BOLD}ArcGIS Velocity Logger${RESET}).
...
${BOLD}${WHITE}EXAMPLES${RESET}
  ...
  ${CYAN}./scripts/release.sh v1.2.3 \\
    ...
    --sign-product-names "ArcGIS Velocity Logger"${RESET}
...
if [[ "$LIST" == true ]]; then
  ...
  # Render with rich formatting if jq-style --json is available, plain fallback otherwise
