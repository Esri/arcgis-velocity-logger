...
| `--sign-product-names <names>` | Optional | Passed to `sign.sh` as `--product-names <names>`. Defaults to the official app product name. Use comma-separated names for multiple source directories. |
