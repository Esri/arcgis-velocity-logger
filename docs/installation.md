...
```bash
mkdir -p "$HOME/Library/Logs/arcgis-velocity-logger"

xattr -dr com.apple.quarantine \
  "/Applications/VelocityLogger.app"

open "/Applications/VelocityLogger.app" --args \
  "logFile=$HOME/Library/Logs/arcgis-velocity-logger/velocity-logger.log"
```
